...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    fetch('http://localhost:8000/api/tasks').then(function (response) {
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("li", [
    _c("div", { staticClass: "row", class: { done: _vm.tasks.performed } }, [
      _c("div", { staticClass: "col-2" }, [
        _c("input", {
          attrs: { type: "checkbox" },
          on: {
            change: function($event) {
              _vm.tasks.performed = !_vm.tasks.performed
            }
          }
        })
      ]),
      ...
      _c("div", { staticClass: "col-8" }, [
        _c("p", [_vm._v(_vm._s(_vm.tasks.text))])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "col-2" }, [
        _c(
          "button",
          {
            ...
            on: {
              click: function($event) {
                return _vm.$emit("delete-task", _vm.tasks.id)
              }
            }
          },
          [_vm._v("\n                ×\n            ")]
